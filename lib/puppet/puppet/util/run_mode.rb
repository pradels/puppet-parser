...
module Puppet
  module Util
    class RunMode
      ...
      def conf_dir
        which_dir(
          (Puppet.features.microsoft_windows? ? File.join(Dir::COMMON_APPDATA, "PuppetLabs", "puppet", "etc") : "/etc/puppetlabs/puppet"),
          "~/.puppet"
        )
      end
      ...
      def var_dir
        which_dir(
          (Puppet.features.microsoft_windows? ? File.join(Dir::COMMON_APPDATA, "PuppetLabs", "puppet", "var") : "/var/opt/lib/pe-puppet"),
          "~/.puppet/var"
        )
      end
